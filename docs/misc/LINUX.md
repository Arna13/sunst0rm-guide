...
This is only necessary if you want to follow this guide. You can always use [the linux version of the script](https://github.com/MCApollo/sunst0rm) (If you want to use it natively, [here's a fast audi r8's guide](https://github.com/afastaudir8/sunst0rm-guide-linux))    
